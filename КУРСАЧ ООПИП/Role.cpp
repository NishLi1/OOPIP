...
std::deque<UserRecord> g_users; // Контейнер для хранения логина и пароля пользователей
std::vector<InfoBasicStaff> b_infos; // Контейнер для хранения базового персонала
std::vector<InfoSpecialist> s_infos; // Контейнер для хранения специалистов
std::vector<InfoManager> m_infos; // Контейнер для хранения менеджер
std::unordered_map<std::string, std::vector<std::string>> dept_members; // Контейнер для хранения отдела и специалистов в них
std::string g_recommendation;
// Перегрузка оператора вывода для базового персонала
...
// Перегрузка оператора ввода для базового персонала
